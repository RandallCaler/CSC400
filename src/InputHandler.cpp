...
void InputHandler::updatePosition(glm::vec3 norm, Entity *penguin){
    penguin->position.x += penguin->m.velocity * norm.x;
    penguin->position.y += norm.y;
    penguin->position.z += penguin->m.velocity *norm.z;
